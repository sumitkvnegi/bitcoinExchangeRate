...
const CoinDetails = () => {
  ...
  const [days, setDays] = useState('34h');
  ...
  return <Container maxW={'container.xl'}>
    ...
    <Box borderWidth={'1'} w={'full'}><Chart arr={chartArray} currency={currencySymbol} days={days} /></Box>
    ...
    <VStack spacing={'4'} p='16' alignItems={'flex-start'}>
      ...
      <Box w={'full'} p='4'>
        <Item title={'Max Supply'} value={coin.market_data.low_24h[currency]} />
